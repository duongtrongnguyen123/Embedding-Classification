...
from text8_embedding import SGNS 

# TIỀN XỬ LÝ ĐỒNG BỘ

# Định nghĩa lại các hằng số Regex và Set bị thiếu
...
def _norm_token(tok: str) -> str:
    # ĐỒNG BỘ CÁC ĐỊNH NGHĨA ROMAN_SMALL, _year_re với code gốc
    if tok.isdigit():
...
#  TẢI DỮ LIỆU THÔ IMDB (Đã xác định từ cấu trúc folder)
...
# TẢI VÀ CHUẨN BỊ WORD EMBEDDING
...
# TRÍCH XUẤT ĐẶC TRƯNG (MAPPING & GAP)
